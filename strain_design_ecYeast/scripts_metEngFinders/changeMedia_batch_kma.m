%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% model = changeMedia_batch_kma(model,media,flux)
%
...
%
% Ivan Domenzain        2018-10-10
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [model,pos] = changeMedia_batch_kma(model,c_source,media,flux)
...
model = setParam(model, 'ub', 'r_1729_REV', 1000); % 'phosphate exchange';
