...
fid = fopen('../ComplementaryData/newpathway_newRxnMatrix.tsv');
...
fid  = fopen('../ComplementaryData/newpathway_newRxnProp.tsv','r');
...
% Add metabolite data:
fid = fopen('../../ComplementaryData/newpathway_newRxnMetAnnotation.tsv');
