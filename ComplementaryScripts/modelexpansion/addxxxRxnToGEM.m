...
fid = fopen('../ComplementaryData/xxx_newRxnMatrix.tsv');
...
fid  = fopen('../ComplementaryData/xxx_newRxnProp.tsv','r');
...
% Add metabolite data:
fid = fopen('../../ComplementaryData/xxx_newRxnMetAnnotation.tsv');
