# Yeast Cell Factory: Large-scale *in silico* strain design for enhanced production of +100 chemicals in *S. cerevisiae*
...
| L-leucine  | C6H13NO2 | C00123 | 15603 | native | amino acid | Link |
...
| Nicotianamine  | C12H21N3O6 | C05324 | 17721 | heterologous | amino acid | Link |
...
| Geraniol  | C10H18O | C01500 | 17447 | heterologous | terpene | Link |
...
* For users: Clone it from [`master`](https://github.com/SysBioChalmers/CellFactory-yeast-GEM) in the Github repo, or just download [the latest release](https://github.com/SysBioChalmers/CellFactory-yeast-GEM/releases).
* For contributors: Fork it to your Github account, and create a new branch from [`devel`](https://github.com/SysBioChalmers/CellFactory-yeast-GEM/tree/devel).
